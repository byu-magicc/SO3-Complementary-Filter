...
def get_time_offset(parser, estimate):
  for msg in estimate:
    ...
    if (quat.x != 0): # this finds the time when filter started
      imu = parser.get_messages('/camera/imu')
...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--bagfile", default= '/home/boatlanding/data/cf/cf_02-09-2023_14:59:40/cf_02-09-2023_14:59:40_0.db3',type=str, help="ROS2 bagfile (*.db3) to read data from.")
